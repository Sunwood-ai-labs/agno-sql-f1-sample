...
```diff
--- a/cookbook/examples/agents/deep_knowledge.py
...
--- a/cookbook/examples/agents/deep_knowledge.py
+++ b/cookbook/examples/agents/deep_knowledge.py
@@ -4,132 +4,206 @@ This agent performs iterative searches through its knowledge base, breaking down
...
---
### [afc962a] - Deep knowledge

  - 作者: Ashpreet
  - 日時: 2025-02-04 20:36:23 +0000
  - 詳細:
...
---
### [8888c99] - Update performance evals for other frameworks (#2006)

  - 作者: Dirk Brand
  - 日時: 2025-02-04 17:41:44 +0200
  - 詳細:
		This updates the evaluation scripts for Smolagents, CrewAI and PydanticAI
...
---
### [5f23d3b] - Update study scout

  - 作者: Ashpreet
  - 日時: 2025-02-04 12:23:01 +0000
  - 詳細:
...
```diff
--- a/cookbook/agent_concepts/memory/09_using_other_models_for_memory.py
...
---
### [e03f941] - Add reasoning param

  - 作者: Ashpreet
  - 日時: 2025-02-04 12:20:53 +0000
  - 詳細:
...
---
### [8eca64f] - Add study scout

  - 作者: Ashpreet
  - 日時: 2025-02-04 12:20:15 +0000
  - 詳細:
...
+
--- /dev/null
+++ b/cookbook/agent_concepts/memory/03_using_other_models_for_memory.py
@@ -0,0 +1,226 @@
...
---
### [17da65f] - Add google maps toolkit [AG-2575] (#1962)

  - 作者: Dirk Brand
  - 日時: 2025-02-04 13:44:23 +0200
  - 詳細:
		## Description
		
		This adds a toolkit for using Google Maps API to search for place
		information, directions, etc.
		
		Thanks to @gauravdhiman for getting us started!
...
---
### [d521b71] - Fix pagination in github tools and add tests (#1996)

  - 作者: Dirk Brand
  - 日時: 2025-02-04 13:05:16 +0200
  - 詳細:
		## Description
		
		Pagination wasn't done correctly for github tools. This fixes that and
		adds tests.
...
---
### [584f784] - Fix implementation of zoom tools (#1986)

  - 作者: Dirk Brand
  - 日時: 2025-02-04 09:43:57 +0200
  - 詳細:
		## Description
		
		Zoom tools did not work in its current state.
